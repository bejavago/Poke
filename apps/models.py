...
class Poke(models.Model):
	poker = models.ForeignKey(User, related_name="pokerpokes",on_delete = models.CASCADE, null=True)
	poked = models.ForeignKey(User, related_name="pokedpokes",on_delete = models.CASCADE, null=True)
	created_at = models.DateField(null=True)
